...
//        testIsValid(testUrlPartsOptions, options);
      ...
      do {
         ...
         for (int testPartsIndexIndex = 0; testPartsIndexIndex < testPartsIndex.length; ++testPartsIndexIndex) {
            ...
            if(testPartsIndexIndex == 0) {
            	//System.out.println("scheme is " + part[index].item);
            }
         ...
         //System.out.println("validCount is " + validCount);
         ...
         if(result == true) {
        	 //System.out.println("result url is " + url);
        	 validCount++;
        	 //System.out.println("validCount is " + validCount);
         }
         if(result == false)
        	 //System.out.println("bad url is " + url);
        	 //
        	 //System.out.println("result url is " + url);
         //
   ...
   static boolean incrementTestPartsIndex(int[] testPartsIndex, Object[] testParts) {
      ...
      //for (int testPartsIndexIndex = testPartsIndex.length; testPartsIndexIndex >= 0; --testPartsIndexIndex) {
         ...
         //System.out.println("index is " + index + " part.length is " + part.length);
